...
class SaveLlmResponse:
    ...
    def push_thumbnail(self, thumbnail_image):
        '''write the thumbnail to the data/video-metadata/thumbnail.png

        Args:
            thumbnail_image: image path for the thumbnail
        
        '''

        with open(self.data_dir/'video-metadata'/'thumbnail.png', 'wb') as file_writer:
            file_writer.write(thumbnail_image)
